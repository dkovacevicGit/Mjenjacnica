...
// (DO NOT EDIT: machine generated header) 'frxDBSet.pas' rev: 35.00 (Windows)
...
//-- type declarations -------------------------------------------------------
enum DECLSPEC_DENUM TfrxDataSetOption : unsigned char { dsoStringAsDisplayText };

typedef System::Set<TfrxDataSetOption, TfrxDataSetOption::dsoStringAsDisplayText, TfrxDataSetOption::dsoStringAsDisplayText> TfrxDataSetOptions;
...
__published:
	...
	__property TfrxDataSetOptions DataSetOptions = {read=FDSOptions, write=FDSOptions, nodefault};
public:
