...
// (DO NOT EDIT: machine generated header) 'frxStorage.pas' rev: 35.00 (Windows)
...
public:
	...
	__fastcall TListBaseHashTable();
	__fastcall virtual ~TListBaseHashTable();
};
...
public:
	...
	__fastcall TListStringHashTable();
	__fastcall virtual ~TListStringHashTable();
};
...
public:
	...
	void __fastcall Clear();
	__fastcall TListStreamHashTable();
	__fastcall virtual ~TListStreamHashTable();
};
