...
// (DO NOT EDIT: machine generated header) 'frxXML.pas' rev: 35.00 (Windows)
...
public:
	...
	virtual void __fastcall AddItem(TfrxXMLItem* Item);
	...
	virtual void __fastcall SetData(const System::UnicodeString AName, const System::UnicodeString AText, const System::UnicodeString AValue);
