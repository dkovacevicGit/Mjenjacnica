...
// (DO NOT EDIT: machine generated header) 'frxClass.pas' rev: 35.00 (Windows)
...
#include <frxProtocolFactory.hpp>
...
class DELPHICLASS TfrxDataLink;
class DELPHICLASS TfrxComponent;
__interface DELPHIINTERFACE IfrxAggregateObject;
typedef System::DelphiInterface<IfrxAggregateObject> _di_IfrxAggregateObject;
...
class DELPHICLASS TfrxDigitalSignatureView;
...
__interface DELPHIINTERFACE IfrxDelayedCommand;
...
class DELPHICLASS TfrxCustomAggregateList;
...
__interface DELPHIINTERFACE IInspectedProperties;
typedef System::DelphiInterface<IInspectedProperties> _di_IInspectedProperties;
__interface DELPHIINTERFACE IStringClassNameContainer;
...
enum DECLSPEC_DENUM Frxclass__3 : unsigned char { csFrxDesigning, csFrxWriting, csFrxSerializeToDict, csFrxSerializeToPreviewPages, csFrxModifyObject, csFrxExporting, csFrxInteractiveForms };

typedef System::Set<Frxclass__3, Frxclass__3::csFrxDesigning, Frxclass__3::csFrxInteractiveForms> TfrxComponentState;

enum DECLSPEC_DENUM Frxclass__4 : unsigned char { csContainer, csPreviewVisible, csDefaultDiff, csHandlesNestedProperties, csContained, csAcceptsFrxComponents, csObjectsContainer };

typedef System::Set<Frxclass__4, Frxclass__4::csContainer, Frxclass__4::csObjectsContainer> TfrxComponentStyle;
...
enum DECLSPEC_DENUM TfrxShowDialogOption : unsigned char { doShowExportSettings, doShowSaveDialog };

typedef System::Set<TfrxShowDialogOption, TfrxShowDialogOption::doShowExportSettings, TfrxShowDialogOption::doShowSaveDialog> TfrxShowDialogOptions;
...
typedef bool __fastcall (__closure *TfrxObjectManualBuildEvent)(TfrxReportComponent* ReportObject);
...
private:
	...
	System::Types::TDirection FDirection;
	
protected:
	virtual void __fastcall Notify(void * Ptr, System::Classes::TListNotification Action);
	HIDESBASE virtual void * __fastcall Get(int Index);
	HIDESBASE virtual void __fastcall Put(int Index, const void * Value);
	virtual int __fastcall GetCount();
	
public:
	__property int Count = {read=GetCount, nodefault};
	__property System::Types::TDirection SearchDirection = {read=FDirection, write=FDirection, nodefault};
...
typedef System::TMetaClass* TfrxObjectsNotifyListClass;

enum DECLSPEC_DENUM TfrxDataLinkProcessing : unsigned char { dpString, dpExpression };

enum DECLSPEC_DENUM TfrxDataLinkLoadType : unsigned char { dltOnGetData, dltOnPreview };

typedef System::Set<TfrxDataLinkLoadType, TfrxDataLinkLoadType::dltOnGetData, TfrxDataLinkLoadType::dltOnPreview> TfrxDataLinkLoading;

#pragma pack(push,4)
class PASCALIMPLEMENTATION TfrxDataLink : public System::Classes::TPersistent
{
	typedef System::Classes::TPersistent inherited;
	
private:
	System::UnicodeString FLink;
	System::UnicodeString FTempLink;
	TfrxDataLinkProcessing FProcessingType;
	TfrxDataLinkLoading FLoadingType;
	void __fastcall SetLink(const System::UnicodeString Value);
	
public:
	__fastcall TfrxDataLink();
	__fastcall virtual ~TfrxDataLink();
	virtual void __fastcall Assign(System::Classes::TPersistent* Source);
	System::UnicodeString __fastcall Diff(const System::UnicodeString PropName, TfrxDataLink* ADataLink);
	__classmethod void __fastcall SaveState(TfrxDataLink* ADataLink);
	__classmethod void __fastcall RestoreState(TfrxDataLink* ADataLink);
	__classmethod TfrxDataLinkLoadType __fastcall GetLoadType(Frxprotocolfactory::TfrxDataLinkLoadMethod LoadMethod);
	__classmethod System::UnicodeString __fastcall GetLink(TfrxDataLink* ADatalink, Frxprotocolfactory::TfrxDataLinkLoadMethod LoadMethod);
	__classmethod bool __fastcall IsExpressionLink(TfrxDataLink* ADataLink);
	__classmethod bool __fastcall IsDataLinkStored(TfrxDataLink* ADataLink, TfrxComponentState ComponentState);
	
__published:
	__property System::UnicodeString Link = {read=FLink, write=SetLink};
	__property TfrxDataLinkProcessing ProcessingType = {read=FProcessingType, write=FProcessingType, default=0};
	__property TfrxDataLinkLoading LoadingType = {read=FLoadingType, write=FLoadingType, default=1};
};
...
private:
	...
	TfrxComponentState FfrComponentState;
	...
	void __fastcall SetIsDesigning(const bool Value);
	bool __fastcall GetIsWriting();
	void __fastcall SetIsWriting(const bool Value);
...
protected:
	...
	bool FHighlighted;
	__classmethod virtual TfrxObjectsNotifyListClass __fastcall GetObjectListClass();
	...
	virtual TfrxReport* __fastcall GetReport();
...
public:
	...
	virtual void __fastcall Assign(System::Classes::TPersistent* Source);
	void __fastcall AssignToDict(TfrxComponent* Source);
	...
	virtual void __fastcall AssignOriginals(TfrxComponent* Source);
	...
	__property bool IsWriting = {read=GetIsWriting, write=SetIsWriting, nodefault};
	...
	__property TfrxComponentState frComponentState = {read=FfrComponentState, write=FfrComponentState, nodefault};
...
__interface  INTERFACE_UUID("{63ABB456-F4C9-49DA-ADA2-E3ABC7125B15}") IfrxAggregateObject  : public System::IInterface 
{
	virtual TfrxComponent* __fastcall GetParentContainer() = 0 ;
	virtual TfrxComponent* __fastcall GetDataRowContainer() = 0 ;
	virtual System::Classes::TList* __fastcall GetDataContainers() = 0 ;
	virtual System::UnicodeString __fastcall GetExpression() = 0 ;
	virtual System::UnicodeString __fastcall GetExpressionDelimiters() = 0 ;
	virtual TfrxComponent* __fastcall GetInstance() = 0 ;
};
...
private:
	...
	void __fastcall DoDestroyControl();
	void __fastcall DoSetParent();
	void __fastcall DoInitControl();
	
protected:
	int FCurrentPPI;
	virtual void __fastcall CorrectControlCoordinates();
	virtual System::Types::TPoint __fastcall GetCoordinateOffset();
	int __fastcall GetScaledControlHeight();
	int __fastcall GetScaledControlLeft();
	int __fastcall GetScaledControlTop();
	int __fastcall GetScaledControlWidth();
	virtual void __fastcall SetAnchors(const TfrxAnchors Value);
	virtual void __fastcall SetLeft(System::Extended Value);
	virtual void __fastcall SetTop(System::Extended Value);
	virtual void __fastcall SetWidth(System::Extended Value);
...
public:
	...
	virtual bool __fastcall IsMemoBlobField(const System::UnicodeString fName);
...
public:
	...
	virtual System::UnicodeString __fastcall Diff(TfrxComponent* AComponent);
	void __fastcall Highlighting(Vcl::Graphics::TCanvas* Canvas, System::Uitypes::TColor AColor);
...
public:
	...
	virtual System::Extended __fastcall GetLastShiftAmount(System::Extended aFreeSpace);
...
private:
	...
	TfrxDataLink* __fastcall GetDataLink();
	bool __fastcall IsDataLinkStored();
	void __fastcall SetDataLink(TfrxDataLink* const Value);
...
protected:
	...
	virtual void __fastcall Notification(System::Classes::TComponent* AComponent, System::Classes::TOperation Operation);
	virtual void __fastcall DefineProperties(System::Classes::TFiler* Filer);
	virtual System::WideString __fastcall GetText();
	virtual System::Variant __fastcall GetValue();
	virtual void __fastcall SetText(const System::WideString Value);
	virtual void __fastcall SetPartMemoText(const System::WideString Value);
	bool __fastcall LoadDataStream(System::Classes::TStream* Stream, const System::UnicodeString NewLink);
	System::UnicodeString __fastcall GetLink(Frxprotocolfactory::TfrxDataLinkLoadMethod LoadMethod);
	bool __fastcall IsExpressionLink();
...
public:
	...
	__classmethod virtual System::UnicodeString __fastcall GetDescription();
	virtual System::UnicodeString __fastcall Diff(TfrxComponent* AComponent);
	virtual System::UnicodeString __fastcall DiffText(TfrxComponent* AComponent);
	virtual System::Extended __fastcall CalcHeight();
	...
	__property System::Variant Value = {read=GetValue, write=FValue};
	...
	__property TfrxDataLink* DataLink = {read=GetDataLink, write=SetDataLink, stored=IsDataLinkStored};
...
private:
	void *__IfrxDataLinkObject;	// Frxprotocolfactory::IfrxDataLinkObject 
	
public:
	#if defined(MANAGED_INTERFACE_OPERATORS)
	// {83CD083D-0399-44F2-B0F7-3A3F8109EE0E}
	operator Frxprotocolfactory::_di_IfrxDataLinkObject()
	{
		Frxprotocolfactory::_di_IfrxDataLinkObject intf;
		this->GetInterface(intf);
		return intf;
	}
	#else
	operator Frxprotocolfactory::IfrxDataLinkObject*(void) { return (Frxprotocolfactory::IfrxDataLinkObject*)&__IfrxDataLinkObject; }
	#endif
...
private:
	Frxbasegraphicstypes::TfrxGraphicDrawProps FGraphicProps;
	...
	Frxbasegraphicstypes::_di_IfrxCachedGraphic FCached;
	Frxpicturegraphics::TfrxCustomGraphicFormatClass FGFormat;
	void __fastcall SetPicture(Vcl::Graphics::TPicture* const Value);
	void __fastcall PictureChanged(System::TObject* Sender);
	Vcl::Graphics::TPicture* __fastcall GetPicture();
	void __fastcall UpdateGraphicHelper();
...
protected:
	void __fastcall SetCachedGraphic(const Frxbasegraphicstypes::_di_IfrxPictureCache PictureCache);
	void __fastcall GetCachedGraphic(Frxbasegraphicstypes::TfrxCachedGraphicType ACacheType, const Frxbasegraphicstypes::_di_IfrxPictureCache PictureCache);
	void __fastcall ReleaseCachedGraphic();
	bool __fastcall IsUpdateRequired(Frxbasegraphicstypes::TfrxCachedGraphicType NewCacheType);
...
public:
	...
	int __fastcall GraphicWidth();
	int __fastcall GraphicHeight();
	bool __fastcall GraphicTransparency();
	bool __fastcall GraphicIsVector();
	bool __fastcall GraphicHasAlpha();
	bool __fastcall GraphicHasMaskColor();
	System::Uitypes::TColor __fastcall GraphicTransparentColor();
...
__published:
	__property Cursor = {default=0};
	__property bool AutoSize = {read=GetValue, write=SetValue, index=0, default=0};
	__property bool Center = {read=GetValue, write=SetValue, index=1, default=0};
	__property DataField = {default=0};
	__property DataSet;
	__property DataSetName = {default=0};
	__property TfrxDataLink* DataLink = {read=GetDataLink, write=SetDataLink, stored=IsDataLinkStored};
	...
	__property bool KeepAspectRatio = {read=GetValue, write=SetValue, index=2, default=1};
	__property Vcl::Graphics::TPicture* Picture = {read=GetPicture, write=SetPicture, stored=FIsPictureStored};
	__property bool Stretched = {read=GetValue, write=SetValue, index=3, default=1};
	__property TagStr = {default=0};
	__property URL = {default=0};
	__property bool HightQuality = {read=GetValue, write=SetValue, index=7, nodefault};
	__property bool Transparent = {read=GetValue, write=SetValue, index=4, nodefault};
...
private:
	void *__IfrxDataLinkObject;	// Frxprotocolfactory::IfrxDataLinkObject 
	void *__IfrxCachedView;	// Frxbasegraphicstypes::IfrxCachedView 
...
public:
	...
	operator Frxbasegraphicstypes::_di_IfrxCachedView()
	{
		Frxbasegraphicstypes::_di_IfrxCachedView intf;
		this->GetInterface(intf);
		return intf;
	}
	#else
	operator Frxbasegraphicstypes::IfrxCachedView*(void) { return (Frxbasegraphicstypes::IfrxCachedView*)&__IfrxCachedView; }
	#endif
	
};


enum DECLSPEC_DENUM TPDFSignatureKind : unsigned char { skInvisible, skVisible, skEmpty };

class PASCALIMPLEMENTATION TfrxDigitalSignatureView : public TfrxPictureView
{
	typedef TfrxPictureView inherited;
	
private:
	TPDFSignatureKind FKind;
...
__published:
	__property TPDFSignatureKind Kind = {read=FKind, write=FKind, nodefault};
	__property System::WideString Description = {read=FDescription, write=FDescription};
public:
	/* TfrxPictureView.Create */ inline __fastcall virtual TfrxDigitalSignatureView(System::Classes::TComponent* AOwner) : TfrxPictureView(AOwner) { }
	/* TfrxPictureView.Destroy */ inline __fastcall virtual ~TfrxDigitalSignatureView() { }
	
public:
	/* TfrxComponent.DesignCreate */ inline __fastcall virtual TfrxDigitalSignatureView(System::Classes::TComponent* AOwner, System::Word Flags) : TfrxPictureView(AOwner, Flags) { }
...
public:
	...
	virtual bool __fastcall IsSupportsGuidlines();
	__fastcall virtual ~TfrxPage();
...
public:
	...
	virtual void __fastcall AlignChildren(bool IgnoreInvisible = false, TfrxMirrorControlModes MirrorModes = TfrxMirrorControlModes() );
	virtual void __fastcall Draw(Vcl::Graphics::TCanvas* Canvas, System::Extended ScaleX, System::Extended ScaleY, System::Extended OffsetX, System::Extended OffsetY);
	void __fastcall SetMarginOffset(int PageIndex);
	void __fastcall ClearMarginOffset();
...
public:
	...
	void __fastcall UpdateControlsCoords();
...
__published:
	...
	__property Width = {default=0};
public:
	/* TfrxPage.Destroy */ inline __fastcall virtual ~TfrxDataPage() { }
...
private:
	...
	int FCurrentIndex;
	TfrxCustomPreviewPages* __fastcall GetCurrent();
	TfrxCustomPreviewPages* __fastcall GetMain();
	...
	void __fastcall CurPagesChanged();
	
public:
	__fastcall TfrxPreviewPagesList(TfrxReport* aReport);
	__fastcall virtual ~TfrxPreviewPagesList();
	void __fastcall Clear();
	int __fastcall Count();
	TfrxCustomPreviewPages* __fastcall Add();
	TfrxCustomPreviewPages* __fastcall AddAsCurrent();
...
private:
	...
	TfrxObjectManualBuildEvent FOnObjectManualBuild;
	...
	void __fastcall UpdateGlobalScritVars();
	void __fastcall SetMainPreviewPages(TfrxCustomPreviewPages* const Value);
	void __fastcall FixUpParentReport();
	TfrxCustomPreviewPages* __fastcall GetMainPreviewPages();
	TfrxCustomPreviewPages* __fastcall GetPreviewPages();
	void __fastcall RestoreScriptObjectsRef();
	Frxbasegraphicstypes::TfrxPictureCacheOptions* __fastcall GetPictureCacheOptions();
	
protected:
	virtual void __fastcall Notification(System::Classes::TComponent* AComponent, System::Classes::TOperation Operation);
	virtual void __fastcall DefineProperties(System::Classes::TFiler* Filer);
	void __fastcall DoGetAncestor(const System::UnicodeString Name, System::Classes::TPersistent* &Ancestor);
	void __fastcall PreviewPagesChanged();
...
public:
	...
	bool __fastcall IsReportActionRunning();
	...
	void __fastcall RunDelayedCommands();
	void __fastcall RefreshActivePreviewedReport();
	...
	__property Frxbasegraphicstypes::TfrxPictureCacheOptions* PictureCacheOptions = {read=GetPictureCacheOptions};
...
__published:
	...
	__property TfrxObjectManualBuildEvent OnObjectManualBuild = {read=FOnObjectManualBuild, write=FOnObjectManualBuild};
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TfrxBaseDelayedCommand() { }
	
public:
	/* TObject.Create */ inline __fastcall TfrxBaseDelayedCommand() : System::Classes::TPersistent() { }
...
public:
	...
	__fastcall virtual ~TfrxBasePrepareReportCommand();
...
public:
	...
	/* TfrxBasePrepareReportCommand.Destroy */ inline __fastcall virtual ~TfrxShowReportCommand() { }
...
public:
	...
	/* TfrxBasePrepareReportCommand.Destroy */ inline __fastcall virtual ~TfrxPrepareReportCommand() { }
...
public:
	...
	/* TfrxBasePrepareReportCommand.Destroy */ inline __fastcall virtual ~TfrxRefreshReportCommand() { }
...
public:
	...
	__fastcall virtual ~TfrxLoadFromCommand();
	virtual void __fastcall Run();
};
...
public:
	...
	virtual void __fastcall Run();
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TfrxLoadFromFileCommand() { }
...
public:
	...
	__fastcall virtual ~TfrxLoadFromStreamCommand();
	virtual void __fastcall Run();
};
...
public:
	__fastcall TfrxDelayedCommandManager();
	__fastcall virtual ~TfrxDelayedCommandManager();
	void __fastcall Clear();
	void __fastcall AddCommand(_di_IfrxDelayedCommand Cmd);
	void __fastcall RunAll();
...
protected:
	...
	virtual System::TObject* __fastcall GetDefaultPreferences();
...
public:
	...
	virtual void __fastcall AddPictureToCache(TfrxPictureView* PicView);
	...
	virtual void __fastcall ReportDataEdit() = 0 ;
	virtual void __fastcall ReportEditVariable() = 0 ;
	virtual bool __fastcall IsDataTree(System::TObject* aObject) = 0 ;
	virtual void __fastcall SetSelection(TfrxComponent* AComponent, const System::UnicodeString PropName, const System::Types::TPoint &SelStart, const System::Types::TPoint &SelEnd) = 0 ;
	virtual System::UnicodeString __fastcall GetDataSelectedAsExp() = 0 ;
...
public:
	...
	void __fastcall AssignOriginalSharedProperties();
...
private:
	...
	System::UnicodeString FPageNumbers;
	TfrxReport* FReport;
	TfrxShowDialogOptions FShowDialogOptions;
	...
	void __fastcall SetShowDialog(bool b);
	bool __fastcall GetShowDialog();
...
public:
	...
	__property TfrxShowDialogOptions ShowDialogOptions = {read=FShowDialogOptions, write=FShowDialogOptions, default=3};
	
__published:
	__property TfrxCustomIOTransport* IOTransport = {read=FIOTransport, write=FIOTransport};
	__property bool ShowDialog = {read=GetShowDialog, write=SetShowDialog, default=1};
...
#pragma pack(push,4)
class PASCALIMPLEMENTATION TfrxCustomAggregateList : public System::TObject
{
	typedef System::TObject inherited;
...
public:
	...
	virtual void __fastcall AddItems(TfrxReportPage* Page) = 0 ;
	virtual void __fastcall AddValue(TfrxComponent* DataRow, int VColumn = 0x0) = 0 ;
	virtual bool __fastcall AddCalculatedValue(TfrxComponent* DataRow, const System::Variant &Value, int VColumn = 0x0) = 0 ;
	virtual bool __fastcall AddAggregatedItem(_di_IfrxAggregateObject AObject, TfrxComponent* Container, System::Classes::TList* AList = (System::Classes::TList*)(0x0)) = 0 ;
	virtual void __fastcall DeleteValue(TfrxComponent* DataRow) = 0 ;
	virtual void __fastcall SaveValue(TfrxComponent* DataRow) = 0 ;
	virtual void __fastcall RestoreValue(TfrxComponent* DataRow) = 0 ;
	virtual void __fastcall EndKeep() = 0 ;
	virtual void __fastcall Reset(TfrxComponent* ParentContainer) = 0 ;
	virtual void __fastcall StartKeep() = 0 ;
	virtual System::Variant __fastcall GetValue(TfrxComponent* ParentContainer, const System::UnicodeString ComplexName, int VColumn = 0x0) = 0 /* overload */;
	virtual System::Variant __fastcall GetValue(TfrxComponent* ParentContainer, int VColumn, const System::UnicodeString Name, const System::UnicodeString Expression, TfrxComponent* DataRow, int Flags) = 0 /* overload */;
public:
	/* TObject.Create */ inline __fastcall TfrxCustomAggregateList() : System::TObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TfrxCustomAggregateList() { }
...
protected:
	...
	virtual TfrxCustomAggregateList* __fastcall GetAggregates() = 0 ;
...
public:
	...
	virtual void __fastcall Stretch(TfrxReportComponent* Band, bool SkipGetData = false) = 0 ;
	virtual void __fastcall UnStretch(TfrxReportComponent* Band) = 0 ;
	virtual void __fastcall InitializeSplit(TfrxReportComponent* Container, System::Classes::TList* SavedObjects, System::Classes::TList* SplitObject) = 0 ;
	virtual bool __fastcall SplitObjects(TfrxReportComponent* Container, System::Classes::TList* SavedObjects, System::Classes::TList* SplitObject, System::Extended AHeight) = 0 ;
	virtual void __fastcall FinalizeSplit(TfrxReportComponent* Container, System::Classes::TList* SavedObjects, System::Classes::TList* SplitObject, bool IsObjectSplit, System::Extended SplitHeight) = 0 ;
	...
	virtual System::Variant __fastcall GetAggregateValue(const System::UnicodeString Name, const System::UnicodeString Expression, TfrxComponent* DataRow, int Flags) = 0 ;
	...
	__property TfrxCustomAggregateList* Aggregates = {read=GetAggregates};
...
protected:
	...
	virtual Frxbasegraphicstypes::TfrxPictureCacheOptions* __fastcall GetPictureCacheOptions();
...
public:
	...
	virtual void __fastcall FireMouseLeave();
	...
	virtual Frxbasegraphicstypes::_di_IfrxCachedGraphic __fastcall GetPicture(Frxbasegraphicstypes::TfrxCachedGraphicType CacheType, int ImageIndex) = 0 ;
	virtual void __fastcall AddPicture(TfrxPictureView* Picture) = 0 ;
	virtual int __fastcall AddGraphic(Vcl::Graphics::TGraphic* Graphic) = 0 ;
	...
	virtual void __fastcall AddFromPreviewPages(TfrxCustomPreviewPages* vPreviewPages) = 0 ;
...
protected:
	...
	virtual TfrxCustomPreviewPages* __fastcall GetPreviewPages();
...
public:
	...
	virtual bool __fastcall Lock() = 0 ;
	...
	virtual bool __fastcall HasVisibleTabs() = 0 ;
	virtual void __fastcall PreviewPagesChanged() = 0 ;
...
private:
	...
	System::UnicodeString __fastcall GetComponentClassName();
...
public:
	...
	int __fastcall Count();
	void __fastcall RemoveEditor(TfrxInPlaceEditorClass AClass);
...
typedef TfrxRectArray *PfrxRectArray;
...
public:
	__fastcall TfrxComponentEditorsClasses();
	...
	void __fastcall UnRegister(TfrxComponentClass ComponentClass)/* overload */;
	void __fastcall UnRegister(TfrxComponentClass ComponentClass, TfrxInPlaceEditorClass EditroClass)/* overload */;
...
private:
	...
	void __fastcall ClearPropInfo();
	
public:
	__fastcall TfrxExtPropList();
	__fastcall virtual ~TfrxExtPropList();
...
public:
	__fastcall virtual TfrxCustomObjectPreset();
	...
	virtual void __fastcall BeginDraw(Vcl::Graphics::TCanvas* Canvas, System::Extended ScaleX, System::Extended ScaleY, const System::Types::TRect &Area);
	virtual void __fastcall EndDraw(Vcl::Graphics::TCanvas* Canvas, System::Extended ScaleX, System::Extended ScaleY, const System::Types::TRect &Area);
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TfrxCustomObjectPreset() { }
...
extern DELPHI_PACKAGE void __fastcall frxUnregisterEditorsClass(TfrxComponentClass ComponentClass, TfrxInPlaceEditorClass EditroClass);
