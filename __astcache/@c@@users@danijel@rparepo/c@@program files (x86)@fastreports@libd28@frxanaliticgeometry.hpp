...
// (DO NOT EDIT: machine generated header) 'frxAnaliticGeometry.pas' rev: 35.00 (Windows)
...
extern DELPHI_PACKAGE TDoublePoint __fastcall DoublePoint(const System::Types::TPoint &P)/* overload */;
...
extern DELPHI_PACKAGE TDoubleRect __fastcall DoubleRect(const Frxclass::TfrxRect &R)/* overload */;
...
extern DELPHI_PACKAGE int __fastcall RectWidth(const System::Types::TRect &R)/* overload */;
extern DELPHI_PACKAGE System::Extended __fastcall RectWidth(const Frxclass::TfrxRect &R)/* overload */;
