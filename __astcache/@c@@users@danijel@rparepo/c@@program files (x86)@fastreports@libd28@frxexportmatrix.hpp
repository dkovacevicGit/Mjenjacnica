...
// (DO NOT EDIT: machine generated header) 'frxExportMatrix.pas' rev: 35.00 (Windows)
...
private:
	...
	Frxpicturegraphics::TfrxCustomGraphicFormatClass FVertorGHelper;
	Frxexporthelpers::TOnProcessHyperLink FOnGetURL;
...
public:
	__fastcall TfrxIEMatrix(const bool UseFileCache, const System::UnicodeString TempDir, Frxbasegraphicstypes::TfrxThumbnailBuildType CacheType);
	...
	bool __fastcall IsExist(int ObjIndex);
	...
	void __fastcall SetGraphicType(const System::UnicodeString TypeName);
	...
	__property Frxexporthelpers::TOnProcessHyperLink OnGetURL = {read=FOnGetURL, write=FOnGetURL};
...
private:
	...
	Frxbasegraphicstypes::_di_IfrxCachedGraphic FImage;
	...
	Vcl::Graphics::TGraphic* __fastcall GetImage();
...
public:
	...
	__property Vcl::Graphics::TGraphic* Image = {read=GetImage};
