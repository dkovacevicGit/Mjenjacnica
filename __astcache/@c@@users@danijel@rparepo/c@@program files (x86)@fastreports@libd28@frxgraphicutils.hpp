...
// (DO NOT EDIT: machine generated header) 'frxGraphicUtils.pas' rev: 35.00 (Windows)
...
private:
	typedef System::DynamicArray<int> _TfrxDrawText__1;
...
private:
	...
	void __fastcall frxExtTextOut(Vcl::Graphics::TCanvas* C, int X, int Y, int add1, int i, int j, System::Extended CosA, System::Extended SinA, System::WideString s, System::AnsiString AnsiStr);
	...
	void __fastcall DrawSelectedTextLine(Vcl::Graphics::TCanvas* C, const System::WideString s, int X, int Y, int DX, int LineIndex, Frxclass::TfrxHAlign Align, HFONT &fh, HFONT &oldfh);
...
public:
	...
	void __fastcall SetText(System::Widestrings::TWideStrings* Text, bool FirstParaBreak = false, int TopLineIndex = 0x0);
	...
	void __fastcall DrawText(Vcl::Graphics::TCanvas* C, Frxclass::TfrxHAlign HAlign, Frxclass::TfrxVAlign VAlign, Frxclass::TfrxUnderlinesTextMode UnderlinesTextMode = (Frxclass::TfrxUnderlinesTextMode)(0x0), int SelectedLine = 0xffffffff);
	...
	System::DynamicArray<int> __fastcall GetLineY();
