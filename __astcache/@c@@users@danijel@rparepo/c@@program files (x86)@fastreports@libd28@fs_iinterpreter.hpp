...
// (DO NOT EDIT: machine generated header) 'fs_iinterpreter.pas' rev: 35.00 (Windows)
...
public:
	__fastcall TfsComponentHelper(const System::UnicodeString Name, const System::UnicodeString ClassName);
public:
...
public:
	...
	TfsComponentHelper* __fastcall AddComponent(System::Classes::TComponent* c);
	...
	TfsCustomHelper* __fastcall Find(const System::UnicodeString Name, bool IncludeComponentHelper = true);
