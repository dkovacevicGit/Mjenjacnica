...
// (DO NOT EDIT: machine generated header) 'frxEMFAbstractExport.pas' rev: 35.00 (Windows)
...
public:
	Frxanaliticgeometry::TDoublePoint DeviceDPI;
...
private:
	...
	int __fastcall GetLineOrientation();
	void __fastcall Decomposition();
	Frxclass::TfrxPoint __fastcall GetXFormScale();
	System::Extended __fastcall GetXFormAverageScale();
	void __fastcall SetClipHRGN(const HRGN Value);
	Frxanaliticgeometry::TDoublePoint __fastcall GetDeviceDPI();
...
protected:
	...
	System::Uitypes::TColor __fastcall IndirectBrushAverageColor(unsigned ih, TEnhMetaObjArray EnhMetaObjArray);
	System::Uitypes::TColor __fastcall DIBPatternBrushAverageColor(unsigned ih, TEnhMetaObjArray EnhMetaObjArray);
	
public:
	__fastcall virtual ~TDeviceContext();
	virtual void __fastcall CopyFrom(System::TObject* ADC);
	virtual void __fastcall Init();
	bool __fastcall IsFontHeight();
	System::Uitypes::TColor __fastcall BrushAverageColor(unsigned ih, TEnhMetaObjArray EnhMetaObjArray);
	__property HRGN ClipRgn = {read=FData.ClipHRgn, write=SetClipHRGN, nodefault};
	...
	__property Frxanaliticgeometry::TDoublePoint DeviceDPI = {read=GetDeviceDPI};
public:
...
public:
	/* TFont.Create */ inline __fastcall TEMFFont() : Vcl::Graphics::TFont() { }
	/* TFont.Destroy */ inline __fastcall virtual ~TEMFFont() { }
...
protected:
	...
	System::Uitypes::TColor __fastcall BrushAverageColor(unsigned ih);
	...
	virtual TEMFFont* __fastcall FontCreate();
	...
	Frxclass::TfrxPoint __fastcall LogToDevPoint(const Frxanaliticgeometry::TDoublePoint &LP)/* overload */;
