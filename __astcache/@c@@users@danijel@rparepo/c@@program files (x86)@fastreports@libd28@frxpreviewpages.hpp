...
// (DO NOT EDIT: machine generated header) 'frxPreviewPages.pas' rev: 35.00 (Windows)
...
class DELPHICLASS TfrxSignaturePages;
...
class PASCALIMPLEMENTATION TfrxSignaturePages : public System::Classes::TStringList
{
...
public:
	__fastcall TfrxSignaturePages();
	void __fastcall Activate();
	void __fastcall Deactivate();
	bool __fastcall IsContaine(System::UnicodeString Name);
	__property bool Active = {read=FActive, nodefault};
public:
	/* TStringList.Destroy */ inline __fastcall virtual ~TfrxSignaturePages() { }
...
private:
	...
	Frxbasegraphicstypes::TfrxCachedGraphicType FCachedGraphicState;
	...
	bool __fastcall ProcessHyperlink(Frxclass::TfrxHyperlink* Hyperlink);
	void __fastcall ThumbnailsUpdated(System::TObject* Sender, Frxpicturecache::TfrxThumbnailsUpdateState UpdateState);
	
protected:
	TfrxSignaturePages* FSignaturePages;
	virtual int __fastcall GetCount();
	virtual Frxclass::TfrxReportPage* __fastcall GetPage(int Index);
	virtual System::Types::TPoint __fastcall GetPageSize(int Index);
	void __fastcall UpdateCachedObject(Frxclass::TfrxComponent* CachedObject, bool IsLoading = false);
...
public:
	...
	virtual int __fastcall AddGraphic(Vcl::Graphics::TGraphic* Graphic);
	...
	virtual Frxbasegraphicstypes::_di_IfrxCachedGraphic __fastcall GetPicture(Frxbasegraphicstypes::TfrxCachedGraphicType CacheType, int ImageIndex);
	...
	virtual void __fastcall AddFrom(Frxclass::TfrxReport* Report)/* overload */;
	virtual void __fastcall AddFromPreviewPages(Frxclass::TfrxCustomPreviewPages* vPreviewPages)/* overload */;
